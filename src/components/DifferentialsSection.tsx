...
const DifferentialsSection = () => {
  ...
  return <section id="differentials" ref={sectionRef} className="py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {differentials.map((differential, index) => <Card key={index} className="differential-card fade-in-up group hover:shadow-elegant transition-all duration-500 border-primary/10 relative overflow-hidden">
        ...
        <div className="bg-white rounded-3xl shadow-elegant p-8 md:p-12">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            ...
            <div className="group">
              <div className="text-4xl md:text-5xl font-bold text-primary mb-2 group-hover:scale-110 transition-transform duration-300">Exclusivo</div>
              <div className="text-gold font-semibold text-lg mb-1">Atendimento</div>
              <div className="text-sm text-muted-foreground">Atendimento exclusivo </div>
            </div>
          </div>
        </div>
      </div>
